...
const styles = StyleSheet.create({
  ...
  applyBtnText: { color: colors.white, fontSize: 13, fontWeight: '800' },
  ...
  tileValue: { fontSize: 22, fontWeight: '800', color: colors.textLight, letterSpacing: -0.5 },
  ...
  typeChipLabel: { fontSize: 11.5, color: colors.slate500, fontWeight: '700' },
  typeChipValue: { fontSize: 12.5, color: colors.textLight, fontWeight: '800' },
  ...
  reqDates: { flex: 1, fontSize: 15, fontWeight: '800', color: colors.textLight, letterSpacing: -0.2 },
  badge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: radii.sm },
  badgeText: { fontSize: 10, fontWeight: '800' },
  reqMeta: { fontSize: 11.5, color: colors.slate500, fontWeight: '700' },
  reqReason: { fontSize: 12.5, color: colors.slate600, lineHeight: 17 },
  reqNote: { fontSize: 12, color: colors.slate500, fontStyle: 'italic' },
  withdraw: { alignSelf: 'flex-start', paddingVertical: 4 },
  withdrawText: { fontSize: 12.5, fontWeight: '800', color: colors.danger },
});
