...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 17, fontWeight: '800', color: colors.textLight, letterSpacing: -0.2 },
  headerActions: { flexDirection: 'row', alignItems: 'center', gap: 16 },
  markAll: { fontSize: 12.5, fontWeight: '700', color: colors.brand[700] },

  list: { paddingHorizontal: 12, paddingVertical: 8 },
  spacer: { marginVertical: 24 },
  error: { color: colors.danger, fontSize: 13, fontWeight: '600', padding: 20, textAlign: 'center' },

  empty: { alignItems: 'center', gap: 8, paddingVertical: 40, paddingHorizontal: 32 },
  emptyTitle: { fontSize: 14.5, fontWeight: '800', color: colors.slate600 },
  emptyBody: { fontSize: 12.5, color: colors.slate400, textAlign: 'center', lineHeight: 18 },
  ...
  rowText: { flex: 1 },
  rowTitle: { fontSize: 13.5, fontWeight: '800', color: colors.textLight },
  rowBody: { fontSize: 13, color: colors.slate600, marginTop: 2, lineHeight: 18 },
